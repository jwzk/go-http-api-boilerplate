...
func TestHTTPBookHandler_getBook(t *testing.T) {
	...
	t.Run("ok 200", func(t *testing.T) {
		...
		r := chi.NewRouter()
		bookRouter := BookRouter{l: logger, getBookUC: uc}
...
func TestHTTPBookHandler_getBooks(t *testing.T) {
	logger := logger.New("test")
	givenBook := model.Book{ID: "1", Title: "Title", Author: "Author", PublicationDate: time.Unix(1, 1)}
	...
	t.Run("ok 200", func(t *testing.T) {
		...
		r := chi.NewRouter()
		bookRouter := &BookRouter{l: logger, getBooksUC: uc}
...
func TestHTTPBookHandler_createBook(t *testing.T) {
	logger := logger.New("test")
	givenBook := model.Book{ID: "1", Title: "Title", Author: "Author", PublicationDate: time.Unix(1, 1)}
	...
	t.Run("ok 200", func(t *testing.T) {
		...
		r := chi.NewRouter()
		bookRouter := &BookRouter{l: logger, createBookUC: uc}
	...
	t.Run("error dto validation bad request 404", func(t *testing.T) {
		r := chi.NewRouter()
		bookRouter := &BookRouter{l: logger}
		r.Post("/", bookRouter.createBook())
...
func TestHTTPBookHandler_updateBook(t *testing.T) {
	logger := logger.New("test")
	givenBook := model.Book{ID: "1", Title: "Title", Author: "Author", PublicationDate: time.Unix(1, 1)}
	...
	t.Run("ok 200", func(t *testing.T) {
		...
		r := chi.NewRouter()
		bookRouter := &BookRouter{l: logger, updateBookUC: uc}
	...
	t.Run("error dao 500", func(t *testing.T) {
		uc := func(ctx context.Context, book model.Book) (model.Book, error) {
			return givenBook, errors.New("test error")
		}
...
func TestHTTPBookHandler_deleteBook(t *testing.T) {
	logger := logger.New("test")
	...
	t.Run("ok 200", func(t *testing.T) {
		...
		r := chi.NewRouter()
		bookRouter := &BookRouter{l: logger, deleteBookUC: uc}
